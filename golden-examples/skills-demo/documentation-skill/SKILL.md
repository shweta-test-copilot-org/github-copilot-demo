...
| Component | Purpose |
|-----------|---------|
| [Instructions](instructions/documentation-patterns.instructions.md) | Documentation standards and patterns |
| [Prompts](prompts/generate-docs.prompt.md) | Reusable documentation generation prompt |
| [References](references/DOC-TEMPLATES.md) | Documentation templates and examples |
